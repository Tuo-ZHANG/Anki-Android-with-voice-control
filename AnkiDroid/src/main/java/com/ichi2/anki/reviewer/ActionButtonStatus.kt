...
class ActionButtonStatus(private val reviewerUi: ReviewerUi) {
    ...
    fun setup(preferences: SharedPreferences) {
        ...
        setupButton(preferences, R.id.action_undo, "customButtonUndo", SHOW_AS_ACTION_NEVER)
        setupButton(preferences, R.id.action_schedule, "customButtonScheduleCard", SHOW_AS_ACTION_NEVER)
        setupButton(preferences, R.id.action_flag, "customButtonFlag", SHOW_AS_ACTION_NEVER)
        setupButton(preferences, R.id.action_tag, "customButtonTags", SHOW_AS_ACTION_NEVER)
        setupButton(preferences, R.id.action_edit, "customButtonEditCard", SHOW_AS_ACTION_ALWAYS)
        setupButton(preferences, R.id.action_add_note_reviewer, "customButtonAddCard", MENU_DISABLED)
        setupButton(preferences, R.id.action_replay, "customButtonReplay", SHOW_AS_ACTION_NEVER)
        ...
        setupButton(preferences, R.id.action_suspend, "customButtonSuspend", SHOW_AS_ACTION_ALWAYS)
        setupButton(preferences, R.id.action_mark_card, "customButtonMarkCard", SHOW_AS_ACTION_NEVER)
